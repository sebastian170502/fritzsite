  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative rounded-full border-none bg-secondary/50 hover:bg-secondary">
                            ...
                            <div className="flex flex-1 flex-col justify-between">
                                ...
                                <div className="flex items-center justify-between mt-2">
                                     <div className="flex items-center border rounded-md h-8">
                                        ...
                                        <div className="px-2 text-sm font-medium min-w-[1.5rem] text-center">{item.quantity}</div>
                                        <button 
